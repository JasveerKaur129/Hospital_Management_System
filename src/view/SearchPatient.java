...
public class SearchPatient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String  q      = "select * from Patient where Pat_id=? ";
		...
		out.println("<th>Address</th> <th>Age</th> <th>Contact Number</th> <th>Problem</th>");
		out.println("<th>Gender</th> <th>Emergency Contact Number</th> </tr>");
			...
			out.println(" <td> " + RS.getLong(8));//status			
			out.println("</tr>"); 
